...
const onUserLogin = async (userID, userName) => {
  return ZegoUIKitPrebuiltCallService.init(
    1807122534, // You can get it from ZEGOCLOUD's console
    "ea619fdbd341312f2cefc83a1625b47e3af8f10b1cc231fa065d42d908fdf695", // You can get it from ZEGOCLOUD's console
    userID,
    userName,
    [ZIM, ZPNs],
    {
